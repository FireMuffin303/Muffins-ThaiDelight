package net.firemuffin303.muffinsthaidelightfabric.client.renderer.customEffectRender;
...
public class DurianHeatEffectRenderer implements CustomEffectRenderer {
    private static final ResourceLocation DURIAN_ICON = ThaiDelight.modid("textures/gui/special_effect/durian_consumed.png");
    private static final ResourceLocation HEATED_UP_ICON = ThaiDelight.modid("textures/gui/special_effect/heated_up.png");
