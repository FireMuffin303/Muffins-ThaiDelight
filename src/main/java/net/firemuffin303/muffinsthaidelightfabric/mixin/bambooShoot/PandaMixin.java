package net.firemuffin303.muffinsthaidelightfabric.mixin.bambooShoot;
...
public abstract class PandaMixin {
    ...
    private static boolean muffins$addBambooShootForPanda(boolean original, @Local ItemStack itemStack){
        return itemStack.is(ModItems.BAMBOO_SHOOT) || itemStack.is(ModItems.DURIAN_CAKE) || itemStack.is(ModItems.DURIAN_CAKE_SLICE) || original;
    }
    ...
    public boolean muffins$addFood(boolean original, @Local(argsOnly = true) ItemStack itemStack){
        return itemStack.is(ModItems.BAMBOO_SHOOT) || original;
    }
    ...
    public boolean muffins$addCake(boolean original,@Local(argsOnly = true) ItemStack itemStack){
        return itemStack.is(ModItems.DURIAN_CAKE) || itemStack.is(ModItems.DURIAN_CAKE_SLICE) || original;
    }
}
