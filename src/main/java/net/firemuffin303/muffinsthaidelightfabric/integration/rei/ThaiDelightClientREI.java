...
import net.firemuffin303.muffinsthaidelightfabric.integration.emi.EMIFermentedFishRecipe;
import net.firemuffin303.muffinsthaidelightfabric.integration.rei.category.CauldronREICategory;
import net.firemuffin303.muffinsthaidelightfabric.integration.rei.category.MortarREICategory;
import net.firemuffin303.muffinsthaidelightfabric.integration.rei.display.CauldronCraftingREIDisplay;
...
import static net.firemuffin303.muffinsthaidelightfabric.integration.jei.FermentedFishRecipeCategory.translateKey;
...
public class ThaiDelightClientREI implements REIClientPlugin {
    ...
    public static final CategoryIdentifier<CauldronCraftingREIDisplay> CAULDRON_ID = CategoryIdentifier.of(ThaiDelight.modid("plugin/cauldron"));
    ...
    public void registerDisplays(DisplayRegistry registry) {
        ...
        registry.add(new CauldronCraftingREIDisplay(
                ...
                List.of(EntryIngredients.of(ModItems.FERMENTED_FISH)),
        ...
        registry.add(new CauldronCraftingREIDisplay(
                ...
                List.of(EntryIngredients.of(ModItems.COCONUT_MILK_BOTTLE)),
    ...
    public static MutableComponent translateKey(@NotNull String suffix) {
        return Component.translatable( ThaiDelight.MOD_ID+ ".jei.cauldron." + suffix);
    }
    ...
    public static void renderCoconutCauldron(GuiGraphics graphics, int mouseX, int mouseY, float delta,Point startPoint){
        ...
        BlockState blockState = ModBlocks.COCONUT_CAULDRON.defaultBlockState().setValue(LayeredCauldronBlock.LEVEL,3);
