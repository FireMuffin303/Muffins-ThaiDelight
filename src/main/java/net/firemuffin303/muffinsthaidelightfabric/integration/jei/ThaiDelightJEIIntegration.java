...
public class ThaiDelightJEIIntegration implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(FERMENTED_FISH, List.of(
                new FermentedFishRecipeCategory.FermentedFishDummy(ModTags.COMMON_RAW_FISHES,Items.BOWL, ModItems.FERMENTED_FISH,new FermentedFishRecipeCategory.FermentedFishCauldronDrawable()){
                    @Override
                ...
                new FermentedFishRecipeCategory.FermentedFishDummy(ModTags.COCONUT,Items.GLASS_BOTTLE,ModItems.COCONUT_MILK_BOTTLE,new FermentedFishRecipeCategory.CoconutCauldronDrawable()){
                    @Override
                    public void renderExtra(GuiGraphics guiGraphics, IDrawable timeIcon, IDrawable slot) {
