...
public class ModBlocksFabric {
    ...
    public static Block SPICY_MINCED_PORK_SALAD_FEAST = new vectorwing.farmersdelight.common.block.FeastBlock(FabricBlockSettings.copyOf(Blocks.CAKE),() -> ModItemsFabric.SPICY_MINCED_MEAT_SALAD, true){
        @Override
    ...
    public static Block CRAB_FRIED_RICE = new vectorwing.farmersdelight.common.block.FeastBlock(FabricBlockSettings.copyOf(Blocks.CAKE),() -> ModItemsFabric.CRAB_FRIED_RICE,true){
        @Override
        public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
            final VoxelShape PLATE_SHAPE = Block.box(1.0D, 0.0D, 1.0D, 15.0D, 2.0D, 15.0D);
    ...
    private static void register(String id,Block block){
        Registry.register(BuiltInRegistries.BLOCK,ThaiDelight.ModResource(id),block);
        Item item = new BlockItem(block,new Item.Properties());
        Registry.register(BuiltInRegistries.ITEM,ThaiDelight.ModResource(id),item);
