...
public class ThaiDelightBlockTagProvider extends BlockTagsProvider {
    public ThaiDelightBlockTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
        super(output, lookupProvider, ThaiDelightCommon.MOD_ID, existingFileHelper);
    }

    @Override
    protected void addTags(HolderLookup.Provider arg) {
        this.tag(BlockTags.PLANKS).add(ModBlocks.DURIAN_PLANKS.get(),ModBlocks.MANGO_PLANKS.get(),ModBlocks.COCONUT_PLANKS.get());
        this.tag(BlockTags.WOODEN_STAIRS).add(ModBlocks.DURIAN_STAIRS.get(),ModBlocks.MANGO_STAIRS.get(),ModBlocks.COCONUT_STAIRS.get());
        this.tag(BlockTags.WOODEN_SLABS).add(ModBlocks.DURIAN_SLAB.get(),ModBlocks.MANGO_SLAB.get(),ModBlocks.COCONUT_SLAB.get());
        this.tag(BlockTags.WOODEN_FENCES).add(ModBlocks.DURIAN_FENCE.get(),ModBlocks.MANGO_FENCE.get(),ModBlocks.COCONUT_FENCE.get());
        this.tag(BlockTags.FENCE_GATES).add(ModBlocks.DURIAN_FENCE_GATE.get(),ModBlocks.MANGO_FENCE_GATE.get(),ModBlocks.COCONUT_FENCE_GATE.get());
        this.tag(BlockTags.WOODEN_DOORS).add(ModBlocks.DURIAN_DOOR.get(),ModBlocks.MANGO_DOOR.get(),ModBlocks.COCONUT_DOOR.get());
        this.tag(BlockTags.WOODEN_TRAPDOORS).add(ModBlocks.DURIAN_TRAPDOOR.get(),ModBlocks.MANGO_TRAPDOOR.get(),ModBlocks.COCONUT_TRAPDOOR.get());
        this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(ModBlocks.DURIAN_PRESSURE_PLATE.get(),ModBlocks.MANGO_PRESSURE_PLATE.get(),ModBlocks.COCONUT_PRESSURE_PLATE.get());
        this.tag(BlockTags.WOODEN_BUTTONS).add(ModBlocks.DURIAN_BUTTON.get(),ModBlocks.MANGO_BUTTON.get(),ModBlocks.COCONUT_BUTTON.get());

        this.tag(BlockTags.STANDING_SIGNS).add(ModBlocks.DURIAN_SIGN.get(),ModBlocks.MANGO_SIGN.get(),ModBlocks.COCONUT_SIGN.get());
        this.tag(BlockTags.WALL_SIGNS).add(ModBlocks.DURIAN_WALL_SIGN.get(),ModBlocks.MANGO_WALL_SIGN.get(),ModBlocks.COCONUT_WALL_SIGN.get());
        this.tag(BlockTags.CEILING_HANGING_SIGNS).add(ModBlocks.DURIAN_HANGING_SIGN.get(),ModBlocks.MANGO_HANGING_SIGN.get(),ModBlocks.COCONUT_HANGING_SIGN.get());
        this.tag(BlockTags.WALL_HANGING_SIGNS).add(ModBlocks.DURIAN_WALL_HANGING_SIGN.get(),ModBlocks.MANGO_WALL_HANGING_SIGN.get(),ModBlocks.COCONUT_WALL_HANGING_SIGN.get());
        ...
        this.tag(FLOWER_CRAB_SPAWNABLE_ON).add(
                Blocks.GRASS_BLOCK,
                Blocks.MUD,
