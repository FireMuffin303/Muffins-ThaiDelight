package net.firemuffin303.thaidelight.datagen.provider.recipe.builder;
...
public class MortarRecipeBuilder implements RecipeBuilder {
    ...
    @Override
    public RecipeBuilder unlockedBy(String string, Criterion<?> arg) {
    ...
    @Override
    public void save(RecipeOutput arg, ResourceLocation arg2) {
        /*
