...
public interface IRecipeProvider {
    ...
    static InventoryChangeTrigger.TriggerInstance inventoryTrigger(ItemPredicate... args) {
        return new InventoryChangeTrigger.TriggerInstance(ContextAwarePredicate.CODEC, MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, args);
    }
    ...
    static String getItemName(ItemLike arg) {
        return BuiltInRegistries.ITEM.getKey(arg.asItem()).getPath();
    }
