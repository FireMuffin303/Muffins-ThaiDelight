...
public class DurianHeatRendererLayer<T extends LivingEntity, M extends EntityModel<T> & HeadedModel> extends RenderLayer<T,M> {
    public static final ResourceLocation RED_CHEEK = ThaiDelightCommon.modid("textures/entity/player/red_cheek.png");
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, T entity, float f, float g, float h, float j, float k, float l) {
        if(PlatformUtil.getDurianHeatComponent(entity).isHeatUp()){
            poseStack.pushPose();
