...
public class ModVillagerTrades {
    public static List<ModVillagerTrade> trades(){
        ...
        modVillagerTrades.add(new ModVillagerTrade(VillagerProfession.FARMER,1,new MerchantOffer(new ItemCost(Items.EMERALD,1),new ItemStack(ModBlocks.LIME_SAPLING.get(),1),8,2,1)));
        modVillagerTrades.add(new ModVillagerTrade(VillagerProfession.FARMER,1,new MerchantOffer(new ItemCost(Items.EMERALD,1),new ItemStack(ModBlocks.LIME_SAPLING.get(),1),8,2,1)));

        modVillagerTrades.add(new ModVillagerTrade(VillagerProfession.FARMER,2,new MerchantOffer(new ItemCost(Items.EMERALD,8),new ItemStack(ModBlocks.LIME_SAPLING.get()),8,2,1)));
        modVillagerTrades.add(new ModVillagerTrade(VillagerProfession.FARMER,2,new MerchantOffer(new ItemCost(Items.EMERALD,8),new ItemStack(ModBlocks.LIME_SAPLING.get()),8,2,1)));
    ...
    public static List<MerchantOffer> wanderTrade(){
        ...
        merchantOfferList.add(new MerchantOffer(new ItemCost(Items.EMERALD),new ItemStack(ModBlocks.LIME_SAPLING.get(),1),16,2,1));
